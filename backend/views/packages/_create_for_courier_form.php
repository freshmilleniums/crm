...
?>
    ...
    <div class="packages-form">
        ...
        <?php $form = ActiveForm::begin([
            'id' => 'packages-form-ajax',
            'action' => ['packages/create-for-courier'],
        ...
        <?= $form->field($model, 'courier_id')->widget(\kartik\select2\Select2::class, [
            ...
            'pluginOptions' => [
                'allowClear' => true,
                'dropdownParent' => new \yii\web\JsExpression('$("#packageModal")'),
                'ajax' => [
        ...
        <div class="form-group">
            <?= Html::submitButton('Create Package', ['class' => 'btn btn-success package-submit-btn']) ?>
            <?= Html::button('Cancel', ['class' => 'btn btn-secondary', 'data-dismiss' => 'modal']) ?>
        </div>
