...
?>
    ...
    <div class="templates-form">
        ...
        <?php $form = ActiveForm::begin([
            'id' => 'templates-form-ajax',
            'action' => Url::to(['create-ajax']),
        ...
        <?= $form->field($model, 'body')->widget(TinyMceWidget::class, [
            'options' => ['rows' => 10, 'id' => 'template-body'],
            'clientOptions' => [
                'height' => 400,
                'menubar' => false,
                'plugins' => [
                        ...
                        <div class="card-body">
                            ...
                            echo $form->field($doc, "[{$index}]file")->widget(FileInput::class, [
                                'pluginOptions' => [
                                    ...
                                    'showUpload' => false,
                                    'initialPreviewFileType' => !empty(pathinfo($doc->path)['extension']) ?
                                        (in_array(pathinfo($doc->path)['extension'], ['pdf']) ? 'text' : 'image') : 'image',
        ...
        <div class="form-group mt-3">
            <button type="submit" class="btn btn-success template-submit-btn">Create Template</button>
