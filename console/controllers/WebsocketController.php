...
class WebsocketController extends Controller
{
    ...
    public function actionStatus()
    {
        if ($this->isRunning()) {
            ...
            $this->stdout("WebSocket port: 8902\n");
            $this->stdout("HTTP notifications port: 8903\n");
    ...
    private function startDaemon()
    {
        ...
        if ($pid == -1) {
            ...
            $this->stdout("WebSocket: ws://localhost:8902\n");
            $this->stdout("HTTP notifications: http://localhost:8903\n");
