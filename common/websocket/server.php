...
$httpSocket = new SocketServer('0.0.0.0:8903', [], $loop);
$httpServer->listen($httpSocket);

// WebSocket server with proper handshake
$wsSocket = new SocketServer('0.0.0.0:8902', [], $loop);
...
echo "WebSocket server listening on port 8902\n";
echo "HTTP server listening on port 8903\n";
